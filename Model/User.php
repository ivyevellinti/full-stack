...
class User{
    ...
    public function registerUser($user_fullname, $email, $password){
        try{
            ...
            $hashedPassword = password_hash($password, PASSWORD_DEFAULT); //CRIPTOGRAFANDO A SENHA  
            //PREPARAR O BANCO DE DADOS PARA RECEBER O COMANDO ACIMA
            $stmt = $this->db->prepare($sql);

            //REFERENCIAR OS DADOS PASSADOS PELO COMANDO SQL COM OS PARÂMENTROS NA FUNÇÃO
